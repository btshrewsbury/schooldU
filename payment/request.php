...
require_once 'lib/web_constants.php';


session_start();
			try {
				$_SESSION['paypalEmail'] = $_POST["senderEmail"];
		        ...
		        /* The servername and serverport tells PayPal where the buyer
		           ...
		           $url="https://schooldu.com";//dirname('http://'.$serverName.':'.$serverPort.$_SERVER['REQUEST_URI']);
		           /* The returnURL is the location where buyers return when a
		            payment has been succesfully authorized.
		            The cancelURL is the location buyers are sent to when they hit the
		            cancel button during authorization of payment during the PayPal flow                 */
		
		           $returnURL = $url."/payment/receipt.php";
		           $cancelURL = "$url/profile.php" ;
