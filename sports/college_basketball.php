...
class CB { 
	...
	{ 
		...
		$games = Game::getGamesOverDateRangeInSport(1,"$sixMonthsDown","$sixMonthsUp");
		echo "<center><img src='img/bracket_banner/cb_bracket_banner.png' style='height:25px'/></center>";
